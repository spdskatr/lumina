module Lumina.Middleend.Mona.OptimiseArith (optimiseOper) where
import Lumina.Middleend.Mona.Mona (MOper (..), MAtom (..))
...
-- This function is used in the constant propagation optimisation code
optimiseOper :: MOper -> Maybe MOper
optimiseOper mv = case mv of
